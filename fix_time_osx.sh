...
sudo curl -o "/tmp/localtime-toggle" "https://raw.githubusercontent.com/ductator/LocalTime-Toggle/master/sbin/localtime-toggle"
sudo curl -o "/tmp/org.osx86.localtime-toggle.plist" "https://raw.githubusercontent.com/ductator/LocalTime-Toggle/master/Library/LaunchDaemons/org.osx86.localtime-toggle.plist"
